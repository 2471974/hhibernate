package guru.spring.hibernate.bootstrap;

import guru.spring.hibernate.models.*;
import guru.spring.hibernate.repositories.CategoryRepository;
import guru.spring.hibernate.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(2), tableSpoonUom, tacosRecipe));
